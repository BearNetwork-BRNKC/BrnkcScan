      ...
      .then(() => {
        ...
        window.ethereum.request({
          ...
          .then(function (txHash) {
            const successMsg = `<a href="/tx/${txHash}">取消交易</a> successfully sent to the network. The current one will change the status once canceling transaction will be confirmed.`
            Swal.fire({
              title: 'Success',
              html: successMsg,
              icon: 'success'
